...
cat system/system/product/app/WebViewGoogleNX/WebViewGoogleNX.apk.* 2>/dev/null >> system/system/product/app/WebViewGoogleNX/WebViewGoogleNX.apk
rm -f system/system/product/app/WebViewGoogleNX/WebViewGoogleNX.apk.* 2>/dev/null
cat system/system/preload/Gamecenter/Gamecenter.apk.* 2>/dev/null >> system/system/preload/Gamecenter/Gamecenter.apk
rm -f system/system/preload/Gamecenter/Gamecenter.apk.* 2>/dev/null
cat system/system/preload/OPPOStore/OPPOStore.apk.* 2>/dev/null >> system/system/preload/OPPOStore/OPPOStore.apk
rm -f system/system/preload/OPPOStore/OPPOStore.apk.* 2>/dev/null
cat system/system/preload/SmartHome/SmartHome.apk.* 2>/dev/null >> system/system/preload/SmartHome/SmartHome.apk
rm -f system/system/preload/SmartHome/SmartHome.apk.* 2>/dev/null
cat system/system/preload/realmeLink/realmeLink.apk.* 2>/dev/null >> system/system/preload/realmeLink/realmeLink.apk
rm -f system/system/preload/realmeLink/realmeLink.apk.* 2>/dev/null
